...
**termco** is A small suite of functions used to count terms and substrings in strings.  The package wrapsthe **data.table** and **stringi** package to creat fast data frame counts of regular expression terms and substrings.  
