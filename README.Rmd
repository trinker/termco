...
| `accuracy`                   | modelling    | Check accuracy of model against human coder       |
| `classify`                   | modelling    | Assign n tags to text from a model                |
| `coverage`                   | modelling    | Coverage for `term_count` or `search_term` object |
| `uncovered`/`get_uncovered`  | modelling    | Get the uncovered text rom a model                |
