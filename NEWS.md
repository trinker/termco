...
* The **stopwords** package replaces the **tm** package for providing default
  ...
  Suggested by Ken Benoit <a href="https://github.com/trinker/termco/issues/69">issue #69</a>.
...
* `important_terms` now uses `quanteda::dfm_tfidf` rather than `tm::weightTfIdf`.
  ...
  done with the **tm** package.  Suggested by Ken Benoit <a href="https://github.com/trinker/termco/issues/69">issue #69</a>.
